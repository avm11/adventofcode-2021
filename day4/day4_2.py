...
for num in numbers:
    ...
    if winner_card:
        ...
        last_winner_card = winner_card
    bingo_cards = list(filter(lambda c: not c.is_winning(), bingo_cards))
    if not bingo_cards:
        break

if last_winner_card:
    print("Winning number", last_winning_num)
    print(last_winner_card)
    print("Score sum", last_winner_card.score())
    print("Score", last_winner_card.score() * last_winning_num)
else:
    print("No winners :(")
